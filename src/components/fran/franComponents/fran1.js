    ...
    return(
      <div className="fran1Content">
        <div className="titleImg">
          ...
          <img src="/haemulhansang/img/fran/fran1/info_tit.png" alt="창업비용" />
        </div>
        <div className="VAT">
          * VAT별도
        </div>
        ...
        <div className="titleImg">
          ...
          <img src="/haemulhansang/img/fran/fran1/info_tit2.png" alt="창업절차" />
        </div>
            ...
            return (
              <div className="openProStep" key={res.id}> 
                <div className="numberImg">
                  <img src={`/haemulhansang/img/fran/fran1/info_N${res.id}.png`} alt={res.id} />
                </div>
                <div className="title">
                  {res.title}
                </div>
